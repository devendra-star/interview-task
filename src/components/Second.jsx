...
const Second = () => (
    <>
        <div className="second__possibility section__padding" id="possibility">
            <div className="second__possibility-video">
                <video
                    autoPlay
                    loop
                    muted
            ...
            <div className="second__possibility-content">
                <h1 className="gradient__text">Making brands a damn site better</h1>
                <p>Let’s face it, first impressions matter. Your website’s an opportunity to wow your audience, so why waste it with bad design? Because brands win new fans when they’re brave enough to go beyond their creative comfort zone.
                </p>
